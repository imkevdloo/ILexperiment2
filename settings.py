...
PARTICIPANT_FIELDS = ['treatment', 'prolificid','bot_question', 'trees_player_round', 'eco_status', 'trees_player_total', 'trees_p2', 'trees_p3', 'trees_p4', 'trees_group_round', 'trees_group_total',
...
OTREE_ADMIN_PASSWORD = 'IMKE_Experiment'
